...
@section("sidebar")
	<div class="wrap_profile_sidebar">
		<p><span class="do" onclick = "document.location.href='/personal_area/update'">Обновить информацию</span></p>
		<p><span class="do" onclick = "document.location.href='/delete/profile'">Удалить профиль</span></p>
	</div>
@endsection
